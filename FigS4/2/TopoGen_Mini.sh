...
# Generate the box
#gmx editconf -f mono.pdb -o newbox.gro -box 6.4 6.4 19.4 -center 3.2 3.2 9.6 #9.6 19.2
gmx editconf -f mono.pdb -o newbox.gro -box 7.5 7.5 22.5 -center 3.75 3.75 11.25
...
num_molecules=$(echo "scale=0; 57000 / $num_atom_per" | bc)
