...
# Generate the box
#gmx editconf -f mono.pdb -o newbox.gro -box 6.4 6.4 19.2 -center 3.2 3.2 9.6 #9.6 19.2
#gmx editconf -f mono.pdb -o newbox.gro -box 6.8 6.8 20.4 -center 3.4 3.4 10.2
gmx editconf -f mono.pdb -o newbox.gro -box 7.2 7.2 21.6 -center 3.6 3.6 10.8
...
num_molecules=$(echo "scale=0; 55000 / $num_atom_per" | bc)
